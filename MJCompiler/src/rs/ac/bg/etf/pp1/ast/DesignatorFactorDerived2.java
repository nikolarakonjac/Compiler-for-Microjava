...
public class DesignatorFactorDerived2 extends DesignatorFactor {

    private Designator Designator;
    private ActParsOptional ActParsOptional;

    public DesignatorFactorDerived2 (Designator Designator, ActParsOptional ActParsOptional) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorFactorDerived2(\n");
