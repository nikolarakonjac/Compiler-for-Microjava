...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(ExprFactorDerived1 ExprFactorDerived1) { visit(); }
    public void visit(NewFactorDerived2 NewFactorDerived2) { visit(); }
    public void visit(NewFactorDerived1 NewFactorDerived1) { visit(); }
    public void visit(DesignatorFactorDerived2 DesignatorFactorDerived2) { visit(); }
    public void visit(DesignatorFactorDerived1 DesignatorFactorDerived1) { visit(); }
    ...
    public void visit(DesignatorDerived4 DesignatorDerived4) { visit(); }
    ...
    public void visit(DesignatorStatementDerived5 DesignatorStatementDerived5) { visit(); }
    ...
    public void visit(VariableFormalParam VariableFormalParam) { visit(); }
    ...
    public void visit(MethodReturnTypeAndNameDerived2 MethodReturnTypeAndNameDerived2) { visit(); }
    public void visit(MethodReturnTypeAndNameDerived1 MethodReturnTypeAndNameDerived1) { visit(); }
    ...
    public void visit(ScopeResolution ScopeResolution) { visit(); }
    public void visit(VarDeclarationDerived1 VarDeclarationDerived1) { visit(); }
    public void visit(ArrayVarDeclaration ArrayVarDeclaration) { visit(); }
    public void visit(VarDeclaration VarDeclaration) { visit(); }
    public void visit(FinalVarDeclarationDerived3 FinalVarDeclarationDerived3) { visit(); }
    public void visit(FinalVarDeclarationDerived2 FinalVarDeclarationDerived2) { visit(); }
    public void visit(FinalVarDeclarationDerived1 FinalVarDeclarationDerived1) { visit(); }
    ...
    public void visit(NoConstAssignmentList NoConstAssignmentList) { visit(); }
    ...
    public void visit(NumberConstValue NumberConstValue) { visit(); }
    public void visit(ConstDeclaration ConstDeclaration) { visit(); }
    public void visit(NoDeclarationList NoDeclarationList) { visit(); }
    public void visit(DeclarationListVar DeclarationListVar) { visit(); }
    public void visit(DeclarationListConst DeclarationListConst) { visit(); }
