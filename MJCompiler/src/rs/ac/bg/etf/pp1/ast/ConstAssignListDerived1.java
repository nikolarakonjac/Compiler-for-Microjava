...
public class ConstAssignListDerived1 extends ConstAssignList {

    private ConstAssignList ConstAssignList;
    private ConstAssign ConstAssign;

    public ConstAssignListDerived1 (ConstAssignList ConstAssignList, ConstAssign ConstAssign) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstAssignListDerived1(\n");
